#!/bin/bash
#SBATCH --job-name=convert_agibot_dexhand
...
# Usage: sbatch --array=0-1023 convert_agibot_dexhand.sh
set -e
...
RAW_DIR="/fsx/ubuntu/taeyoung/data/rlds/agibot_dexhand/1.0.0"
LOCAL_DIR="/fsx/ubuntu/taeyoung/data/processing/intermediate/agibot_dexhand"
TOTAL_SHARDS=1024
