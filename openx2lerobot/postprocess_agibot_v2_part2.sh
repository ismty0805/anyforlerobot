#!/bin/bash
#SBATCH --job-name=postprocess_agibot_v2_part2
...
# Args: DATASET_NAME
DATASET_NAME="agibot_v2_part2"
INTERMEDIATE_DIR="/fsx/ubuntu/taeyoung/data/processing/intermediate/agibot_v2_part2"
...
echo "🎉 Agibot Part 2 Post-processing completed successfully!"
