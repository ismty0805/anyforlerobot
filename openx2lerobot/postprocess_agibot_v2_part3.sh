#!/bin/bash
#SBATCH --job-name=postprocess_agibot_v2_part3
...
# Args: DATASET_NAME
DATASET_NAME="agibot_v2_part3"
INTERMEDIATE_DIR="/fsx/ubuntu/taeyoung/data/processing/intermediate/agibot_v2_part3"
...
echo "🎉 Agibot Part 3 Post-processing completed successfully!"
