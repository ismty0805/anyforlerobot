#!/bin/bash
#SBATCH --job-name=postprocess_agibot_v2_part4
...
# Args: DATASET_NAME
DATASET_NAME="agibot_v2_part4"
INTERMEDIATE_DIR="/fsx/ubuntu/taeyoung/data/processing/intermediate/agibot_v2_part4"
...
echo "🎉 Agibot Part 4 Post-processing completed successfully!"
