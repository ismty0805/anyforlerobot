#!/bin/bash
#SBATCH --job-name=postprocess_droid_v2
...
# Args: DATASET_NAME
DATASET_NAME="droid_v2"
INTERMEDIATE_DIR="/fsx/ubuntu/taeyoung/data/processing/intermediate/droid_v2"
LEROBOT_V3_ROOT="/fsx/ubuntu/taeyoung/data/processing/lerobot_v3_new"
FINAL_V3_DIR="${LEROBOT_V3_ROOT}/${DATASET_NAME}"
EXPECTED_EPISODES=26051
...
# if [ "$FOUND" -lt 70000 ]; then exit 1; fi
